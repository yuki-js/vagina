...
class RealtimeApiClient {
  ...
  Future<void> _configureSession() async {
    ...
    _logService.info(_tag,
        'Configuring session with voice: ${_sessionConfig.voice}, tools: ${_sessionConfig.tools.length}, noise_reduction: ${_sessionConfig.noiseReduction}');
    ...
    switch (eventType) {
      ...
      case null:
        ...
        if (type == null || type.isEmpty) {
          ...
          _logService.warn(
              _tag, 'Unknown/unhandled event type received: $type');
        }
    }
  }
  ...
  void _handleSessionCreated(Map<String, dynamic> message, String eventId) {
    ...
    if (sessionJson != null) {
      ...
      _logService.debug(
          _tag, 'Session ID: ${session.id}, Model: ${session.model}');
    }
  ...
  void _handleTranscriptionSessionUpdated(
  ...
  void _handleConversationItemCreated(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleConversationItemDeleted(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleConversationItemRetrieved(
      Map<String, dynamic> message, String eventId) {
    final itemJson = message['item'] as Map<String, dynamic>?;
    if (itemJson != null) {
      final item = ConversationItem.fromJson(itemJson);
  ...
  void _handleInputAudioTranscriptionCompleted(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleInputAudioTranscriptionDelta(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleInputAudioTranscriptionFailed(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleInputAudioBufferCommitted(
      Map<String, dynamic> message, String eventId) {
    final previousItemId = message['previous_item_id'] as String?;
    final itemId = message['item_id'] as String?;
    _logService.info(_tag,
  ...
  void _handleInputAudioBufferCleared(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleInputAudioBufferSpeechStarted(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleInputAudioBufferSpeechStopped(
      Map<String, dynamic> message, String eventId) {
    final audioEndMs = message['audio_end_ms'] as int?;
    final itemId = message['item_id'] as String?;
    _logService.info(_tag,
  ...
  void _handleOutputAudioBufferStarted(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleOutputAudioBufferStopped(
      Map<String, dynamic> message, String eventId) {
    final responseId = message['response_id'] as String?;
    _logService.debug(_tag,
  ...
  void _handleOutputAudioBufferCleared(
      Map<String, dynamic> message, String eventId) {
    final responseId = message['response_id'] as String?;
    _logService.debug(_tag,
  ...
  void _handleResponseDone(Map<String, dynamic> message, String eventId) {
    ...
    if (responseJson != null) {
      ...
      if (usage != null) {
        ...
        _logService.info(
            _tag, 'Response complete - Status: ${response.status}');
      }
    } else {
  ...
  void _handleResponseOutputItemAdded(
      Map<String, dynamic> message, String eventId) {
    final itemJson = message['item'] as Map<String, dynamic>?;
    final responseId = message['response_id'] as String?;
    ...
    if (itemJson != null) {
      ...
      if (item.type == 'function_call') {
        ...
        _logService.info(
            _tag, 'Function call started: $name (call_id: $callId)');
      } else {
        _logService.debug(
            _tag,
  ...
  void _handleResponseOutputItemDone(
      Map<String, dynamic> message, String eventId) {
    final itemJson = message['item'] as Map<String, dynamic>?;
  ...
  void _handleResponseContentPartAdded(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleResponseContentPartDone(
      Map<String, dynamic> message, String eventId) {
    final partJson = message['part'] as Map<String, dynamic>?;
    final itemId = message['item_id'] as String?;
    ...
    if (partJson != null) {
      final partType = partJson['type'] as String?;
      _logService.debug(
          _tag, 'Content part done: $partType (item_id: $itemId)');
    }
  }
  ...
  void _handleResponseAudioTranscriptDelta(
      Map<String, dynamic> message, String eventId) {
    final delta = message['delta'] as String?;
  ...
  void _handleResponseAudioTranscriptDone(
      Map<String, dynamic> message, String eventId) {
    final transcript = message['transcript'] as String?;
    final itemId = message['item_id'] as String?;
  ...
  void _handleResponseAudioDelta(Map<String, dynamic> message, String eventId) {
    ...
    if (delta != null) {
      ...
      if (_audioChunksReceived == 1) {
        ...
        _logService.info(
            _tag, 'AI audio response started (first chunk received)');
      }
      ...
      if (_audioChunksReceived % AppConfig.logAudioChunkInterval == 0) {
        _logService.debug(
            _tag,
            'Audio delta received (chunk #$_audioChunksReceived, '
  ...
  void _handleResponseAudioDone(Map<String, dynamic> message, String eventId) {
    _logService.info(_tag,
        'Audio response complete. Total chunks received: $_audioChunksReceived');
  ...
  void _handleResponseFunctionCallArgumentsDelta(
      Map<String, dynamic> message, String eventId) {
  ...
  void _handleResponseFunctionCallArgumentsDone(
      Map<String, dynamic> message, String eventId) {
    final callId = message['call_id'] as String?;
    ...
    if (callId != null && _pendingFunctionCalls.containsKey(callId)) {
      ...
      _logService.info(
          _tag, 'Function call complete: $name with args: $arguments');
