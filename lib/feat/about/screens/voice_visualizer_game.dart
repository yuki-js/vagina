...
class VoiceVisualizerGameScreen extends StatefulWidget {
  const VoiceVisualizerGameScreen({super.key});

  @override
  State<VoiceVisualizerGameScreen> createState() => _VoiceVisualizerGameState();
}

class _VoiceVisualizerGameState extends State<VoiceVisualizerGameScreen>
