...
class EndCallTool extends Tool {
  ...
  Future<String> execute(Map<String, dynamic> args) async {
    ...
    try {
      ...
      if (success) {
        return jsonEncode({'success': true, 'ended': true});
      } else {
        return jsonEncode({'success': false, 'error': 'Failed to end call'});
      }
    } catch (e) {
      return jsonEncode({'success': false, 'error': 'Error ending call: $e'});
    }
  }
}
